...
def load_data():
    ...
    train_2019 = pd.read_csv('2019Dec.csv')
    train_2020 = pd.read_csv('2020Dec.csv')
    train_2021 = pd.read_csv('2021Dec.csv')
    train_2022 = pd.read_csv('2022Dec.csv')
    test_2023 = pd.read_csv('2023Dec.csv')
